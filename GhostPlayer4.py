...
class MediaPlayer(QWidget):
    ...
    def init_ui(self):
        ...
        # Remove Media button below the playlist
        self.remove_media_button = QPushButton('Remove Media', self)
        self.remove_media_button.setStyleSheet("background-color: #555; padding: 10px; font-size: 16px;")
        ...
        # Add Media and Remove Media buttons layout (Left half)
        ...
        main_layout.addLayout(left_layout, 1)  # Left: playlist & add/remove media buttons
    ...
    def remove_media(self):
        ...
        if selected_row >= 0:
            # Remove from media files list and the playlist
